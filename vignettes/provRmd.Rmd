...
Even though the `table_y.csv` file already exists and is not created anew, both the `spp_table1.csv` (input) and `table_y.csv` (output) still show up in the provenance tracking dataframe, log, and workflow chart.
