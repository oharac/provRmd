...
``` {r view script_track, echo = TRUE, message = FALSE, warning = FALSE}
names(.script_track)
...
if(!file.exists('table_y.csv')) {
  ...
  git_prov('spp_table1.csv', filetype = 'input')
...
Even though the `table_y.csv` file already exists and is not created anew in this run of the script, both the `spp_table1.csv` (input) and `table_y.csv` (output) still show up in the provenance tracking dataframe, log, and workflow chart.
